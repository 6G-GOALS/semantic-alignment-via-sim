    ...
    pl.DataFrame(
        {
            ...
            'SIM Spacing Divisor Input': cfg.sim.spacing_divisor_input,
            'SIM Spacing Divisor Output': cfg.sim.spacing_divisor_output,
            'SIM Spacing Divisor Intermediate': cfg.sim.spacing_divisor_intermediate,
